...
const Post = ({
    ...
    >
      ...
      <div className="p-3 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-100 dark:border-gray-700 mt-auto">
          ...
          <button className="flex items-center gap-1 hover:text-blue-500 transition-colors group/comment"></button>
          <button
  ...
  const detailBlock = (
    <div className="bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-lg flex flex-col p-0 h-full overflow-hidden">
      {/* 作者信息头部 */}
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        <div className="flex flex-col">
          ...
          <div className="p-6 space-y-6">
            {/* 作者信息卡片 */}
            <div className="bg-white/50 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg p-6">
