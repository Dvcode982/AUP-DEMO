...
import { Home, Search, User, Palette, HelpCircle, LogIn, LogOut, Sun, Moon, Contact, Shapes, Settings, UserCircle, MessageSquare, Hash } from 'lucide-react'
...
const Sidebar = () => {
  ...
  const menuItems = [
    { href: '/messages', label: t('messages'), icon: Contact },
    { href: '/lost-and-found', label: t('lostFoundNav'), icon: Search },
    { href: '/', label: t('home'), icon: Home },
    { href: '/topic-block', label: t('topicBlock'), icon: Shapes },
    { href: '/setting', label: t('settings'), icon: Settings },
    { href: '/feedback', label: t('feedback'), icon: HelpCircle },
  ];
      ...
      <div className="mb-3 md:mb-6 p-2 md:p-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
        ...
        {isAuthenticated && user ? (
          ...
          <div className="bg-blue-50 dark:bg-gray-700 rounded-lg md:p-3 text-center shadow-sm">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-xs md:text-sm mb-2 md:mb-3 hidden md:block">{t('loginTip')}</p>
            <div className="flex flex-col md:flex-row gap-1 md:gap-2">
              ...
              >
                ...
                <span className="md:hidden">{t('registerShort')}</span>
              </Link>
            </div>
          </div>
        )}
        ...
        <ul className="space-y-1">
          ...
          <li className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            >
              ...
              <span className="hidden md:inline">{theme === 'dark' ? t('dayMode') : t('nightMode')}</span>
            </button>
            ...
            >
              ...
              <span className="hidden md:inline">{t('toggleTheme')}</span>
            </button>
          </li>
